...
assets_path = '/workspaces/Br0x-front-end/src/assets'
...
for old_name, new_name in rename_map.items():
    old_path = os.path.join(assets_path, old_name)
    new_path = os.path.join(assets_path, new_name)
